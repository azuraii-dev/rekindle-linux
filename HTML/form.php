<!doctype html>
<!-- 
    I haven't learned PHP so this is just pure HTML 
    If you'd rather have bootstrap locally be my guest lmao 
    I'm sure you'll notice most of this is the default bootstrap example
    bc HTML is a good language to be a lazy coder with
-->
<html lang="en">
  <head>
    <!-- Required meta tags -->
